...
$(document).ready(function() {
	...
	request(function(data) {
		...
		for (var i = 0; i < data.length; i++) {
			var tpl = "<div class=\"row\"><a href=\"buy.jsp?goods_id="+data[i].goods_id+"\"><div class=\"col-md-5 col-sm-5 col-xs-5\" style=\"padding:0px;margin:12px 0;\">" +
	...
	request(function(data) {
		...
		hotShop.empty();
		for (var i = 0; i < data.length; i++) {
			var tpl = "<div class=\"row\"><a href=\"shop.jsp?shop_id="+data[i].shop_id+"\"><div class=\"col-md-5 col-sm-5 col-xs-5\" style=\"padding:0px;margin:12px 0;\">" +
				"<img src=\"img/info/3.jpg\" alt=\"\" class=\"img-responsive\">" +
				"</div>" +
				"<div class=\"col-md-7 col-sm-7 col-xs-7\" style=\"padding-right: 0;padding-top:10px;\">" +
		...
		(function(i) {
			request(function(data) {
				...
				for(var k =0;k<data.length;k++){
					tpl+="<div class=\"row info-content\"><a href=\"buy.jsp?goods_id="+data[k].goods_id+"\">\
											<div class=\"col-md-5 col-sm-5 col-xs-5\">\
												<img src=\"img/info/8.jpg\" class=\"img-responsive\">\
											</div>\
											<div class=\"col-md-7 col-sm-7 col-xs-7\">\
												<h4>"+data[k].goods_name+"</h4>\
												<p class=\"hidden-xs\">犯得上发射点发射点你发送v第三方输入vs的vs的分公司的v深度覆盖了可是v你考虑的v和josef个是给房东vz</p>\
